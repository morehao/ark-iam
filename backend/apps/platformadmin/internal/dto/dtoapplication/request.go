...
type ApplicationCreateReq struct {
	...
	AllowPersonCreateTenant model.AppPersonCreateTenantPolicy `json:"allowPersonCreateTenant"` // 个人是否可自助创建租户(enable/disable，留空按 disable)
	AllowJoinByInvite       model.AppJoinByInvitePolicy       `json:"allowJoinByInvite"`       // 是否允许通过邀请加入租户(enable/disable，留空按 disable)
...
type ApplicationUpdateReq struct {
	...
	Sort                    int                               `json:"sort"`                    // 排序
	AllowPersonCreateTenant model.AppPersonCreateTenantPolicy `json:"allowPersonCreateTenant"` // 个人是否可自助创建租户(enable/disable，留空不修改)
	AllowJoinByInvite       model.AppJoinByInvitePolicy       `json:"allowJoinByInvite"`       // 是否允许通过邀请加入租户(enable/disable，留空不修改)
