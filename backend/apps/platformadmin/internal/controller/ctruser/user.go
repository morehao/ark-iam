...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/user/updatePassword [post]
...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/user/updateStatus [post]
...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/user/assignDepartments [post]
...
// @Router /v1/user/detailUserLoginLog [get]
...
// @Router /v1/user/pageListUserLoginLog [post]
...
// @Success 200 {object} gincontext.DtoRender{data=dtouser.UserLoginLogPageListResp}
// @Router /v1/user/getUserLoginLogByUser [get]
...
// @Router /v1/user/getUserDepartmentByUser [get]
...
// @Router /v1/user/createUserIdentity [post]
...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/user/deleteUserIdentity [post]
...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/user/updateUserIdentity [post]
...
// @Router /v1/user/detailUserIdentity [get]
...
// @Router /v1/user/pageListUserIdentity [post]
...
// @Success 200 {object} gincontext.DtoRender{data=dtouser.UserIdentityPageListResp}
// @Router /v1/user/getUserIdentityByUser [get]
