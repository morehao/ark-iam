...
// @Router /v1/tenantApplication/create [post]
...
// @Router /v1/tenantApplication/delete [post]
...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/tenantApplication/update [post]
...
// @Router /v1/tenantApplication/detail [get]
...
// @Router /v1/tenantApplication/pageList [post]
