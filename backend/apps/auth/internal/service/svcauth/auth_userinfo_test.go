...
func TestUserinfoReturnsPersonAndTenantUser(t *testing.T) {
	...
	if resp.UserInfo.UserID != "21" || resp.UserInfo.TenantID != "11" || resp.UserInfo.Name != "租户用户" || resp.UserInfo.OwnerType != model.OwnerTypeOwner {
...
func TestUserinfoReturnsPersonFromContextWhenPersonMissing(t *testing.T) {
	...
	if resp.UserInfo.UserID != "21" || resp.UserInfo.OwnerType != model.OwnerTypeNormal {
