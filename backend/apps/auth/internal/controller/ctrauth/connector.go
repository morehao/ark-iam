...
// @Router /v1/connector/create [post]
...
// @Router /v1/connector/delete [post]
...
// @Success 200 {object} gincontext.DtoRender{data=string}
// @Router /v1/connector/update [post]
...
// @Router /v1/connector/detail [get]
...
// @Router /v1/connector/pageList [post]
...
// @Router /v1/connector/getFactoryList [post]
...
// @Router /v1/connector/{connectorId}/test [post]
...
// @Router /v1/connector/{connectorId}/authorize [post]
...
// @Router /v1/connector/callback [get]
