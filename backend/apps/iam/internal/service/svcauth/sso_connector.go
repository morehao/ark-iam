...
func (svc *ssoConnectorSvc) Create(ctx *gin.Context, req *dtoauth.SsoConnectorCreateReq) (*dtoauth.SsoConnectorCreateResp, error) {
	...
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Create] json.Marshal config fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return nil, code.GetError(code.SsoConnectorCreateError)
	}
	domainsJson, err := json.Marshal(req.Domains)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Create] json.Marshal domains fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return nil, code.GetError(code.SsoConnectorCreateError)
	}
	brandingJson, err := json.Marshal(req.Branding)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Create] json.Marshal branding fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return nil, code.GetError(code.SsoConnectorCreateError)
	}
	...
	if err := dao.NewSsoConnectorDao().Insert(ctx, insertEntity); err != nil {
		glog.Errorf(ctx, "[svcauth.Create] dao Insert fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return nil, code.GetError(code.SsoConnectorCreateError)
	}
...
func (svc *ssoConnectorSvc) Delete(ctx *gin.Context, req *dtoauth.SsoConnectorDeleteReq) error {
	...
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Delete] dao GetByID fail, err:%v, req:%s", err, gutil.ToJsonString(req))
	...
	if err := dao.NewSsoConnectorDao().Delete(ctx, req.SsoConnectorID, userID); err != nil {
		glog.Errorf(ctx, "[svcauth.Delete] dao Delete fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return code.GetError(code.SsoConnectorDeleteError)
	}
	return nil
}
...
func (svc *ssoConnectorSvc) Update(ctx *gin.Context, req *dtoauth.SsoConnectorUpdateReq) error {
	ssoConnectorEntity, err := dao.NewSsoConnectorDao().GetByID(ctx, req.SsoConnectorID)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Update] dao GetByID fail, err:%v, req:%s", err, gutil.ToJsonString(req))
	...
	configJson, err := json.Marshal(req.Config)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Update] json.Marshal config fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return code.GetError(code.SsoConnectorUpdateError)
	}
	domainsJson, err := json.Marshal(req.Domains)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Update] json.Marshal domains fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return code.GetError(code.SsoConnectorUpdateError)
	}
	brandingJson, err := json.Marshal(req.Branding)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Update] json.Marshal branding fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return code.GetError(code.SsoConnectorUpdateError)
	}
	...
	if err := dao.NewSsoConnectorDao().UpdateMap(ctx, req.SsoConnectorID, updateMap); err != nil {
		glog.Errorf(ctx, "[svcauth.Update] dao UpdateMap fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return code.GetError(code.SsoConnectorUpdateError)
	}
	return nil
}
...
func (svc *ssoConnectorSvc) Detail(ctx *gin.Context, req *dtoauth.SsoConnectorDetailReq) (*dtoauth.SsoConnectorDetailResp, error) {
	ssoConnectorEntity, err := dao.NewSsoConnectorDao().GetByID(ctx, req.SsoConnectorID)
	if err != nil {
		glog.Errorf(ctx, "[svcauth.Detail] dao GetByID fail, err:%v, req:%s", err, gutil.ToJsonString(req))
	...
	if err := json.Unmarshal(ssoConnectorEntity.Config, &config); err != nil {
		glog.Errorf(ctx, "[svcauth.Detail] json.Unmarshal config fail, err:%v", err)
		return nil, code.GetError(code.SsoConnectorGetDetailError)
	}
	var domains any
	if err := json.Unmarshal(ssoConnectorEntity.Domains, &domains); err != nil {
		glog.Errorf(ctx, "[svcauth.Detail] json.Unmarshal domains fail, err:%v", err)
		return nil, code.GetError(code.SsoConnectorGetDetailError)
	}
	var branding any
	if err := json.Unmarshal(ssoConnectorEntity.Branding, &branding); err != nil {
		glog.Errorf(ctx, "[svcauth.Detail] json.Unmarshal branding fail, err:%v", err)
		return nil, code.GetError(code.SsoConnectorGetDetailError)
	}
...
func (svc *ssoConnectorSvc) PageList(ctx *gin.Context, req *dtoauth.SsoConnectorPageListReq) (*dtoauth.SsoConnectorPageListResp, error) {
	...
	if err != nil {
		glog.Errorf(ctx, "[svcauth.PageList] dao GetPageListByCond fail, err:%v, req:%s", err, gutil.ToJsonString(req))
	...
	for _, v := range ssoConnectorEntityList {
		...
		if err := json.Unmarshal(v.Config, &config); err != nil {
			glog.Errorf(ctx, "[svcauth.PageList] json.Unmarshal config fail, err:%v", err)
			continue
		}
		var domains any
		if err := json.Unmarshal(v.Domains, &domains); err != nil {
			glog.Errorf(ctx, "[svcauth.PageList] json.Unmarshal domains fail, err:%v", err)
			continue
		}
		var branding any
		if err := json.Unmarshal(v.Branding, &branding); err != nil {
			glog.Errorf(ctx, "[svcauth.PageList] json.Unmarshal branding fail, err:%v", err)
			continue
		}
