...
type RoleSvc interface {
	Create(ctx *gin.Context, req *dtorole.RoleCreateReq) (*dtorole.RoleCreateResp, error)
	Delete(ctx *gin.Context, req *dtorole.RoleDeleteReq) error
	Update(ctx *gin.Context, req *dtorole.RoleUpdateReq) error
	Detail(ctx *gin.Context, req *dtorole.RoleDetailReq) (*dtorole.RoleDetailResp, error)
	PageList(ctx *gin.Context, req *dtorole.RolePageListReq) (*dtorole.RolePageListResp, error)
}
...
func (svc *roleSvc) Create(ctx *gin.Context, req *dtorole.RoleCreateReq) (*dtorole.RoleCreateResp, error) {
	...
	return &dtorole.RoleCreateResp{
		RoleID: insertEntity.ID,
	}, nil
}

func (svc *roleSvc) Delete(ctx *gin.Context, req *dtorole.RoleDeleteReq) error {
	...
	if err := dao.NewRoleDao().Delete(ctx, req.RoleID, userID); err != nil {
		glog.Errorf(ctx, "[svcrole.Delete] dao Delete fail, err:%v, req:%s", err, gutil.ToJsonString(req))
		return code.GetError(code.RoleDeleteError)
	}
	return nil
}

func (svc *roleSvc) Update(ctx *gin.Context, req *dtorole.RoleUpdateReq) error {
	roleEntity, err := dao.NewRoleDao().GetByID(ctx, req.RoleID)
	if err != nil {
...
func (svc *roleSvc) Detail(ctx *gin.Context, req *dtorole.RoleDetailReq) (*dtorole.RoleDetailResp, error) {
	roleEntity, err := dao.NewRoleDao().GetByID(ctx, req.RoleID)
	if err != nil {
	...
	resp := &dtorole.RoleDetailResp{
		RoleID: roleEntity.ID,
		RoleBaseInfo: objrole.RoleBaseInfo{
...
func (svc *roleSvc) PageList(ctx *gin.Context, req *dtorole.RolePageListReq) (*dtorole.RolePageListResp, error) {
	cond := &dao.RoleCond{
	...
	list := make([]dtorole.RolePageListItem, 0, len(roleEntityList))
	for _, v := range roleEntityList {
		list = append(list, dtorole.RolePageListItem{
			RoleID: v.ID,
			RoleBaseInfo: objrole.RoleBaseInfo{
				TenantID:    v.TenantID,
				Name:        v.Name,
	...
	return &dtorole.RolePageListResp{
		List:  list,
		Total: total,
	}, nil
}